...
const schema = z
  .string()
  .trim()
  .max(2000, "Les commentaires ne peuvent pas dépasser 2000 caractères" );
...
export function ProjectDecompteDepensesCommentsField({
  value,
  onChange,
  disabled,
}: Props) {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-6 gap-4 border-b border-muted pb-2">
      <label className="md:col-span-1 text-sm font-medium">
        Commentaires (dépenses complémentaires)
      </label>
      ...
      <div className="md:col-span-5">
        <textarea
          ...
          placeholder="Justification de la décision concernant les dépenses complémentaires"
        />
