...
/**
 * Commentaires validation des études :
 * - champ optionnel
 * - toujours visible
 * - explique une décision (oui / non)
 */
const schema = z
  .string()
  .trim()
...
export function ProjectValidEtudeCommentsField({
  value,
  onChange,
  disabled,
}: Props) {
    ...
    <div className="grid grid-cols-1 md:grid-cols-6 gap-4 border-b border-muted pb-2">
      ...
      <div className="md:col-span-5">
        <textarea
          ...
          placeholder="Justification de la décision (validation ou refus)"
        />
