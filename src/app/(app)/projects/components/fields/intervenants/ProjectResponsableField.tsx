...
const schema = z
  .string()
  .trim()
  .max(255, "Le nom du responsable doit comporter au maximum 255 caractères")
  .refine(
    (v) => v.length === 0 || v.length >= 2,
    "Le nom du responsable doit comporter au moins 2 caractères"
  );
...
export function ProjectResponsableField({
 value,
  onChange,
}: Props) {
